...
export const GW_ROLES = ["VP_MER_GW", "DPM_GW", "GM_GW", "PRESIDENT_GW", "LOGISTICS_GW", "CLAIM_GW", "SCM_NYK_APPROVER", "SCM_NYK_EVP", "SCM_NYK", "SCM_NYG", "ACCOUNTING"]
...
export const ROLE_ACTIONS: Record<string, string[]> = {
  ...
  // TRM logistics = same NYG-style stages, scoped to TRM docs (Urairat holds this + LOGISTICS_GW)
  LOGISTICS_TRM: ["PENDING_SCM", "PENDING_PRESIDENT", "PENDING_LOGISTICS"],
  // Legacy CLAIM_* roles
  ...
  SCM_NYK_APPROVER: ["PENDING_CLAIM_GW"],
  SCM_NYK_EVP: ["PENDING_CLAIM_GW"],
